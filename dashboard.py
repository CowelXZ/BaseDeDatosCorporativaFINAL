...
def show_page_ia_kmeans():
    ...
    def entrenar_kmeans():
        ...
        # CORRECCIÓN 2: Excluimos 'id_ticket' ANTES del escalado
        ...
        return perfiles, (K_range, inertia), df_gastos.columns[:-1]  # Devolvemos las etiquetas correctas
    ...
    if perfiles is not None:
        ...
        ax.set_xticks(angles[:-1])  # Asignamos los ángulos
        ax.set_xticklabels(labels, color='grey', size=8)  # Asignamos las etiquetas
        ...
        # --- Análisis en Texto (en un expander) ---
...
def show_page_ia_svm():
    ...
    def entrenar_svm():
        ...
        # 1. Generar etiquetas con K-Means
        scaler = StandardScaler()
        df_scaled = scaler.fit_transform(df_gastos)
        kmeans = KMeans(n_clusters=5, random_state=42, n_init=10)
        df['perfil_cliente'] = kmeans.fit_predict(df_scaled)

        # 2. Preparar datos para SVM
    ...
    if accuracy is not None:
        ...
        with col1:
            ...
            # CORRECCIÓN 3: Añadimos el expander con la explicación
...
# =============================================================================
# APLICACIÓN PRINCIPAL (Lógica de Navegación)
# =============================================================================
